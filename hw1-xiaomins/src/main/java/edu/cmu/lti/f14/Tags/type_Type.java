...
public class type_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.f14.Tags.type");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "edu.cmu.lti.f14.Tags.type");
  ...
  public String getGeneName(int addr) {
      ...
      jcas.throwFeatMissing("GeneName", "edu.cmu.lti.f14.Tags.type");
  ...
  public String getSentence(int addr) {
      ...
      jcas.throwFeatMissing("Sentence", "edu.cmu.lti.f14.Tags.type");
  ...
  public int getStart(int addr) {
      ...
      jcas.throwFeatMissing("start", "edu.cmu.lti.f14.Tags.type");
  ...
  public int getEnd(int addr) {
      ...
      jcas.throwFeatMissing("end", "edu.cmu.lti.f14.Tags.type");
